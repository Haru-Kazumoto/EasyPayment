<div class="flex flex-col gap-3">
  ...
  <?php foreach ($students as $student): ?>
    <tr class="bg-white border-b border-gray-200 hover:bg-gray-100 text-gray-900 font-medium whitespace-nowrap">
      ...
      <td class="px-6 py-4">
        <span class="text-xs font-medium px-3 py-1 rounded-lg
          <?= $student['status'] === 'AKTIF' ? 'bg-green-600 text-white' : ($student['status'] === 'TIDAK AKTIF' ? 'bg-yellow-500 text-white' : 'bg-gray-500 text-white') ?>">
          <?= $student['status'] ?? 'BELUM DISET' ?>
        </span>
      </td>
   ...
   <a href="<?= url('students/delete', ['id' => $student['id']]) ?>"
